...
#list of all vowels to remove everythong except them from the name of the movie 
vowels=['a','e','i','o','u']
...
if you feel it is tooamny functions, don't fret just head over to python docs to read about every function that I have used here'''
